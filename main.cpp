...
#include <functional>
#ifdef __ANDROID__
#include <android/log.h> //__android_log_print(ANDROID_LOG_VERBOSE, "Habit", "Example number log: %d", number);
#include <jni.h>
...
int main(int argc, char* argv[])
{
	...
	SDL_Window* window = SDL_CreateWindow("Habit", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, windowWidth, windowHeight, SDL_WINDOW_RESIZABLE);
